...
## V3.14 — Adaptive evidence addendum
...
### V3.14.1 — Evidence-gated systemic/Fishbone investigation
Extreme Analysis now includes a separate systemicity gate over the historical source period. It looks for material recurring patterns and cross-area impact before generating a Fishbone-compatible investigation. A PASS produces a Systemic Issue Investigation evidence sheet and an Extreme presentation view; REVIEW/HOLD prevents a systemic root-cause worksheet from being treated as established fact. Candidate causes remain hypotheses, Five Whys answers require validation, and owners/dates are never invented.
