...
def design_report(
    ...
    ai = analytical_intelligence or {}
    di = decision_intelligence or {}
    ...
    if isinstance(governed, pd.DataFrame) and not governed.empty:
        actions = governed.head(8).to_dict('records')
    ...
    return {
        'version':'1.2', 'department':report_plan.get('department'), 'requesting_team':team, 'entity_context': report_plan.get('entity_context', {}),
        ...
        'rules': {'no_fabrication':True,'main_report_concise':True,'detailed_evidence_in_addendum':True,
                  ...
                  'analytical_intelligence_v3_4': bool(ai),
                  'business_implication_required': True,
                  'decision_action_governance_v3_6': bool(di),
